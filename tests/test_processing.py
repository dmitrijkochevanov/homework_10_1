...
def test_get_dictionary_key(dictionary_key):
    assert get_dictionary_key(dictionary_key) == [
...
def test_get_date_sorted(list_dict, direction, sorted_list):
    assert get_date_sorted(list_dict, direction) == sorted_list
